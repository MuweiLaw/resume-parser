...
public class OfficeOpenXMLConvertProcessor extends AbstractConvertProcessor {
    ...
    private List officeOpenXMLMediaType = Arrays.asList("application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/msword");
    ...
    public boolean isSupport(String mediaType) {
        return officeOpenXMLMediaType.contains(mediaType);
    }
