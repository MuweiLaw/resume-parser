...
import static org.apache.poi.xwpf.converter.xhtml.internal.styles.CSSStylePropertyConstants.*;


/**
 * @author wx
 * @version 1.0.0
 * @className HTMLMapper
 * @description TODO
 * @date 2019/12/7 22:41
 */
public class HTMLMapper extends XWPFDocumentVisitor<Object, XHTMLOptions, XHTMLMasterPage>{
    ...
    public HTMLMapper(XWPFDocument document, ContentHandler contentHandler, XHTMLOptions options) throws Exception {
            ...
            throws Exception
    {
        ...
        if( StringUtils.isNotEmpty(run.getPictureText())){
            characters( run.getPictureText() );
        }
        if ( url != null )
        {
