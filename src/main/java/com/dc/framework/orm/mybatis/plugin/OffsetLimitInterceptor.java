package com.dc.framework.orm.mybatis.plugin;

import java.util.List;
import java.util.Properties;

import com.dc.framework.jdbc.dialect.Dialect;
import com.dc.framework.lang.Strings;
import com.dc.framework.lang.collection.Collections;
import com.dc.framework.lang.collection.PropertiesHelper;
import com.dc.framework.page.PageContext;
import com.dc.framework.page.SortInfo;
...
public class OffsetLimitInterceptor implements Interceptor {
    ...
    void processIntercept(final Object[] queryArgs) {
        ...
        // queryArgs = query(MappedStatement ms, Object parameter, RowBounds rowBounds,
            ...
            if (parameter instanceof PageContext) {
                ...
                if (pc.isUseSort()) {
                    ...
                    if (Collections.isNotEmpty(sorts)) {
                        ...
                        sql = " select * from ( " + sql + ")  paging_query_table____ "
                                + sb.toString();
                    }
                }
            }
    ...
    public void setProperties(Properties properties) {
        ...
        try {
            ...
            throw new RuntimeException("cannot create dialect instance by dialectClass:"
                    + dialectClass, e);
        }
        System.out.println(OffsetLimitInterceptor.class.getSimpleName() + ".dialect="
                + dialectClass);
    }
